  ...
  />
          ...
          <div style={styles.domainsSection}>
            ...
            <button
             ...
             onMouseEnter={(e) => {
               // e.currentTarget.style.backgroundColor = '#218838'; // Remove or comment out this line
               e.currentTarget.style.transform = 'translateY(-2px)';
               e.currentTarget.style.boxShadow = '0 6px 20px rgba(40, 167, 69, 0.4)';
             }}
             onMouseLeave={(e) => {
               // e.currentTarget.style.backgroundColor = '#28a745'; // Remove or comment out this line
               e.currentTarget.style.transform = 'translateY(0)';
