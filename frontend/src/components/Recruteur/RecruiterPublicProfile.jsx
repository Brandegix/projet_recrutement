...
const pageStyles = {
  ...
  headerDivider: {
    ...
    marginBottom: "20px",
    "@media (max-width: 768px)": {
      margin: "0 auto 20px auto", // Center divider on mobile
    },
  },
  ...
  headerDomainsContainer: {
    ...
    marginTop: "5px",
    "@media (max-width: 768px)": {
      justifyContent: "center", // Center tags on mobile
    },
  },
  headerDomainTag: {
  ...
  card: {
    ...
    overflow: "hidden",
    transition: "all 0.3s ease",
    marginLeft: '20px', // Adjusted to be part of responsive padding
    marginRight: '20px', // Adjusted to be part of responsive padding
    marginBottom: '20px',
    "@media (max-width: 1024px)": {
      marginLeft: '0',
      marginRight: '0',
  ...
  cardHeader: {
    ...
    display: "flex", // Ensure toggle icon aligns
    alignItems: "center",
  ...
  contactValue: {
    ...
    color: "#fff",
    fontWeight: "500",
    wordBreak: "break-word", // Handle long emails/addresses
  },
  ...
  statsGrid: {
    ...
    gap: "25px",
    "@media (max-width: 768px)": {
      gridTemplateColumns: "1fr", // Stack stats on mobile
      gap: "15px",
    },
  },
  statItem: {
  ...
  jobGridCard: {
    ...
    transition: "all 0.3s ease",
    backgroundColor: "#1a1a1a",
    display: "flex", // Ensure content is structured
    flexDirection: "column",
    "&:hover": {
      transform: "translateY(-5px)",
      boxShadow: "0 10px 20px rgba(255,107,53,0.2)",
  ...
  jobGridDescription: {
    ...
    lineHeight: "1.5",
    margin: 0,
    flexGrow: 1, // Make description take available space
  },
  ...
  newsletterForm: {
    ...
    "@media (max-width: 768px)": {
      ...
      borderRadius: "16px", // Adjust border radius for stacked look
      border: "none",
  ...
  newsletterButton: {
    ...
    "&:hover": {
      backgroundColor: '#e05a28', // Moved hover styles here for clarity
