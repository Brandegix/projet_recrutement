  ...
  const fetchRecruiters = async () => {
    try {
      ...
      if (response.status === 403) {
        ...
        setError("Accès refusé. Veuillez vous connecter en tant qu'administrateur.");
        setRecruiters([]);
        return;
      }
      ...
      console.log("📢 Recruiter Data in Frontend BEFORE setting state:", data);
  
      setRecruiters(data.map(recruiter => ({
        ...recruiter,
        subscription_active: recruiter.subscription_active ?? false // ✅ Default fallback
      })));
                    ...
                    <td style={{
                      ...
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: "500",
                          color: "white",
                          backgroundColor: recruiter.subscription_active ? "#ff9800" : "#ff9800",
                          cursor: "pointer",
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.backgroundColor = recruiter.subscription_active ? "#ff9800" : "#ff9800";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.transform = "translateY(0)";
