...
socketio = SocketIO(
    app,
    cors_allowed_origins=["https://www.casajobs.ma"],
    async_mode='eventlet',
    manage_session=True
)

# Configuration de la base de données MySQL
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:EEfWKIejjBDptpqMELKCYLFdSJOgwoBg@interchange.proxy.rlwy.net:16489/railway'
...
def get_job_offers_with_logos():
    try:
        ...
        offers_list = [{
            ...
            "logo": offer.JobOffer.logo  # Use the stored logo URL here
        } for offer in offers]
